{{-- filepath: c:\xampp\htdocs\Laravel\blog\resources\views\components\alert.blade.php --}}
@props(['type'])
...
<div id="alert-additional-content-1" class="p-4 mb-4 text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800" role="alert">
    <div class="flex items-center">
      ...
      <h3 class="text-lg font-medium">{{ $title ?? '¡Alerta!' }}</h3>
    </div>
    <div class="mt-2 mb-4 text-sm">
        {{ $slot }}
    </div>
    <div class="flex">
        <button type="button" onclick='window.location.href="https://www.youtube.com/watch?v=dQw4w9WgXcQ";'
...
<div id="alert-additional-content-5" class="p-4 border border-gray-300 rounded-lg bg-gray-50 dark:border-gray-600 dark:bg-gray-800" role="alert">
    <div class="flex items-center">
      ...
      <span class="sr-only">Info</span>
      <h3 class="text-lg font-medium text-gray-800 dark:text-gray-300">{{ $title ?? '¡Alerta!' }}</h3>
    </div>
